...
<body>
   ...
   <input type="hidden" id="ot" name="ot" value="<?php echo $id_orden ?>"/>
		...
		$datos = $con->query('select id_valores as id,concat(id_item," ",item) as Tipo from valores_trabajo as tb1 inner join ticket as tb2 on tb1.id_area=tb2.org_id where tb2.id='.$id_orden.'  order by id ASC');
